  ...
  <div>
    ...
    <div class="services">
      <Services
        ...
        :title="item.title"
        :image-svg="item.sectionImage"
        :image-title="item?.section"
        :image="item.image"
...
import Carriers from "~/assets/BaseIcons/s5.jpg";
import Forwarders from "~/assets/BaseIcons/t3.jpeg";
import Shippers from "~/assets/BaseIcons/s6.jpg";
